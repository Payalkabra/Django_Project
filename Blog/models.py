...
class Flipkart(models.Model):
    mrp = models.CharField(db_column='MRP', max_length=10, blank=True, null=True)  # Field name made lowercase.
    selling_price = models.CharField(db_column='Selling_Price', max_length=10, blank=True, null=True)  # Field name made lowercase.
    ...
    product_url = models.CharField(db_column='Product_URL', max_length=1000, blank=True, null=True)  # Field name made lowercase.
