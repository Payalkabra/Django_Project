# Generated by Django 2.2.1 on 2019-07-04 05:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('mrp', models.CharField(blank=True, db_column='MRP', max_length=10, null=True)),
                ('selling_price', models.CharField(blank=True, db_column='Selling_Price', max_length=10, null=True)),
                ...
                ('product_url', models.CharField(blank=True, db_column='Product_URL', max_length=1000, null=True)),
            ],
            options={
                'db_table': 'Flipkart',
                'managed': False,
